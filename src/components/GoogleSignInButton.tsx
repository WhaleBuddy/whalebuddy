// src/components/layout/google-sign-in-button.tsx
...
export const GoogleSignInButton = () => {
  ...
  return (
    <button
      ...
      disabled={isLoading} 
      className={`flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 px-4 py-2 text-sm font-medium shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2
        ${isLoading 
          ? 'bg-gray-400 text-gray-700 cursor-not-allowed' // Style when disabled
